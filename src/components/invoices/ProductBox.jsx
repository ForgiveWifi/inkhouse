...
function ProductBox({product}) {
  ...
  return (
    <>
      <Link to={`/account/products/${metadata.design_id}`} className="link flexbox-row flex-wrap full-width background1 radius15 shadow2" style={{ padding: "15px", gap: 10, border: "3px solid white"}}>
        {
